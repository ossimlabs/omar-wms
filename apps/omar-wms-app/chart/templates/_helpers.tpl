{{- define "omar-wms.imagePullSecret" }}
...
Common labels
*/}}
{{- define "omar-wms.labels" -}}
omar-wms.sh/chart: {{ include "omar-wms.chart" . }}
{{ include "omar-wms.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "omar-wms.selectorLabels" -}}
app.kubernetes.io/name: {{ include "omar-wms.name" . }}
