...
*/}}
{{- define "omar-wms.imagePullSecrets" -}}
  {{/*
  ...
  */}}
  ...
  {{- if .Values.generatedImagePullSecret -}}
    {{- if .Values.generatedImagePullSecret.create -}}
      {{- $secrets = (append $secrets (.Values.generatedImagePullSecret.name | default (include "omar-wms.fullname" .))) }}
    {{- end -}}
  {{- end -}}
...
{{- define "omar-wms.generateImagePullSecret" }}
