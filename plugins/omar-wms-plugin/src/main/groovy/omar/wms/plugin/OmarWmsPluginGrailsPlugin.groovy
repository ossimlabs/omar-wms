...
class OmarWmsPluginGrailsPlugin extends Plugin {
   ...
   // URL to the plugin's documentation
       def documentation = "https://grails.github.io/OmarWmsPlugin/"
   ...
   //    def issueManagement = [ system: "GitHub", url: "https://github.com/grails/OmarWmsPlugin/issues" ]

       // Online location of the plugin's browseable source code.
   //    def scm = [ url: "https://github.com/grails/OmarWmsPlugin" ]
