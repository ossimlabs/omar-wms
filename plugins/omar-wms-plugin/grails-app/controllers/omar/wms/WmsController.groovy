...
* **histCenterTile:**Currently calculates the histogram from center of image. Can be true|false
	...
	@ApiImplicitParams( [
			...
			@ApiImplicitParam( name = 'format', value = 'MIME Type of result image', defaultValue = "", allowableValues = "image/jpeg, image/png, image/gif", paramType = 'query', dataType = 'string', required = false ),
